    ...
    children: [
      ...
      },
      {
        ...
        checklist: [
          ...
          { text: "Événements : utm_source", done: true },
          { text: "Événements : utm_medium", done: true },
          { text: "Événements : utm_campaign", done: true },
          { text: "Événements : utm_term", done: false },
          { text: "Événements : utm_content", done: true },
          ...
          { text: "Téléchargements : utm_source", done: true },
          { text: "Téléchargements : utm_medium", done: true },
          { text: "Téléchargements : utm_campaign", done: true },
          { text: "Téléchargements : utm_term", done: false },
          { text: "Téléchargements : utm_content", done: true },
      ...
      },
      {
        ...
        blockers: "L'import Gravity Forms crée une copie du formulaire (pas de remplacement possible). La fonctionnalité 'formulaire par défaut' ne fonctionne plus après la migration. L'agence veut facturer la mise en place de cette fonctionnalité, un ticket a été fait à ce sujet.<br><br>L'équipe modifie les titres des posts/contenus, ce qui casse les confirmations liées.",
